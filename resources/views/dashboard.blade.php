        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg shadow-md">
                <div class="p-6 bg-white border-b border-gray-200">
                    <input type="text" class="w-full border border-gray-800 focus:border-purple-900 rounded-sm" placeholder="Search for a Student. (e.g. Michael Agyei or PS/ITC/17/0019)">
                </div>
